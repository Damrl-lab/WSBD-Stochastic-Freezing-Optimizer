"""
Instead of Freezing parameters with a weighted probability distribution
DBD freezes deterministaclly parameters with lowest scores. 
"""
...
def train_qnn_param_shift(x, y, n_qubits, n_layers, num_measurment_gates, num_epochs):
    ...
    freeze_t = 0.70 # adjust freeze threshold if wanted
